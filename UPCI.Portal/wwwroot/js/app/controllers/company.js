...
const companyController = createApp({
    setup() {
        ...
        const GetCompany = async () => {
            ...
            const result = await CompanyService.Search(datatable.filter, datatable.sortColumn, datatable.descending, datatable.pageNum, datatable.pageSize)
...
companyController.mount('#CompanyController');