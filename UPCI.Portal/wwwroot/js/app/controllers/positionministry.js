...
const positionMinistryController = createApp({
    setup() {
        ...
        const Save = async () => {
            ...
            if ($('#form').parsley().isValid()) { 
                $(".preloader").show(); 
                const result = await PositionMinistryService.Save(formData);
...
positionMinistryController.mount('#PositionMinistryController');