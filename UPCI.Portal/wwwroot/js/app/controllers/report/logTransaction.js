...
const controller = createApp({
    setup() {
        ...
        const Download = async () => {
            const result = await ReportService.LogTransactionDownload(datatable.filter, datatable.sortColumn, datatable.descending, datatable.pageNum, datatable.pageSize);
            const blob = new Blob([result.data], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
            const contentDisposition = result.headers['content-disposition'];
            let filename = 'Logs_Transaction.xlsx'; // Default filename in case the header is missing
        ...
        const GetItems = async () => {
            ...
            const result = await ReportService.LogTransaction(datatable.filter, datatable.sortColumn, datatable.descending, datatable.pageNum, datatable.pageSize)
...
controller.mount('#LogTransactionController');